...
// ⚡️ ፍጥነትን ለመጨመርና ከቴሌግራም ጋር ያለውን ግንኙነት ፈጣን ለማድረግ የተስተካከለ ማዋቀሪያ
const bot = new TelegramBot(API_TOKEN, { 
    polling: {
        autoStart: true,
        params: { timeout: 10 } // በፍጥነት መልዕክት እንዲያመጣ ማድረጊያ
    } 
});
...
console.log("🚀 ቦቱ በTermux ላይ እጅግ ፈጣን በሆነ አሰራር ስራ ጀምሯል...");
